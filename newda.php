...
if (!$conn) {
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if (mysqli_num_rows($result) === 1) {
            ...
            $selectFirstName = "SELECT FirstName FROM `sign_up` WHERE `Email`='$Email' AND `active` = 1";
            $resultFirstName = mysqli_query($conn, $selectFirstName);
            ...
            $message = "Your data is changed sucssesfully\n have a good day ,...$firstName...";
            ...
            if ($mail->Send()) {
                ...
                $response = array(
                    "Code" => 200,
                    "message" => "User information updated successfully and email was sent.",
                    "data" => "None"
                );
                echo json_encode($response, JSON_PRETTY_PRINT);
                    ...
                    echo json_encode(array("Code" => 400, "message" => "An update was failed Email could not be sent. Mailer Error: " . $mail->ErrorInfo, "data" => "None"),JSON_PRETTY_PRINT);
                }
        } else {
